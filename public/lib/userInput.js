...
//PRINT MESSAGES --> CONFIRMATION MESSAGES//
       ...
       let {operation} = await  inquirer.prompt(this.options);
            ...
            case 'Add Employee': 
                let {
                    ...
                    eRole, 
                    mgr
                } = await this.getAddEmployeeQuestions();
                let empPostData = { 
                    first_name : fname,
                    last_name: lname,
                    role_id : eRole.id,
                ...
                let {
                    manager
                } = await this.getViewEmployeesByManagerQuestion();
                let inputQuery = {
                    manager: true,
                    query : manager.id
                }
                ...
                let {
                    depSelected
                } = await this.getViewEmployeesByDepartmentQuestion();
                let deptQuery = {
                    department: true,
                ...
                let {
                    emp
                }  = await this.getDeleteEmployeeQuestions();
                ...
                let {
                    ...
                    salary, 
                    department
                } = await this.getAddRoleQuestions();
                let postData = { 
                    title : title,
                    salary: salary,
                ...
                let {
                    role
                } = await this.getDeleteRoleQuestions();
                ...
                let {
                    budget
                } = await this.getBudgetForDepartment();
                ...
                let {
                    delDepartment
                } = await this.getDeleteDepartmentQuestions();
